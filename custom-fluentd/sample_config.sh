...
curl https://raw.githubusercontent.com/fluent/fluentd-docker-image/master/v1.7/debian/fluent.conf > fluent.conf

curl https://raw.githubusercontent.com/fluent/fluentd-docker-image/master/v1.7/debian/entrypoint.sh > entrypoint.sh
